...
local ThemeManager = {} do
    ...
    ThemeManager.BuiltInThemes = {
        ["Vision"] 		= { 1, httpService:JSONDecode([[{"FontColor":"999999","MainColor":"191919","AccentColor":"ffffff","BackgroundColor":"0f0f0f","OutlineColor":"282828"}]]) },
    ...
    function ThemeManager:CreateThemeManager(groupbox)
        ...
        groupbox:AddDropdown("FontFace", {
            Text = "Font Face",
            Default = "Code",
            Values = {"BuilderSans", "Code", "Fantasy", "Gotham", "Jura", "Roboto", "RobotoMono", "SourceSans", "Plex", "Minecraft", "PixelService", "Arcade"}
        })
